	 ...
	 public int isInputNumberValid()  {
		...
		*/
		...
		//YOUR CODE STARTS HERE
               Scanner scanner = new Scanner(System.in); // Scanner object for an integer
                int num;
                while (true) {
            ...
            if (scanner.hasNextInt()) {
                ...
                if (num >= 1 && num <= 10) {
                    ...
                    this.printStream.print( "Invalid entry. Please enter an integer between 1 and 10, both inclusive.");
                    return -1;
                }
            } else {
